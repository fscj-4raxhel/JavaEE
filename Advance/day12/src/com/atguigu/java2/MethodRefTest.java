...
public class MethodRefTest {
	...
	public void test3() {
		...
		System.out.println(com1.compare(12,321));
		System.out.println("**********************");
	...
	public void test4() {
		...
		System.out.println(func2.apply(123.62));
	...
	public void test7() {
		...
		String jerry = func.apply(new Employee(1001, "Jerry", 23, 5000));
		System.out.println(jerry);
		System.out.println("**********************");
		Function<Employee,String> func1 = Employee::getName;
		System.out.println(func1.apply(new Employee(1001,"Tom",34,8990)));
